class FaqsController < ApplicationController
  ...
  def faq
    faq1 = Faq.new
    faq1.faq_question = 'What is gCamp'
    faq1.faq_answer = 'Gcamp is an awesome tool that is going to change your life
    ...
    faq2 = Faq.new
    faq2.faq_question = 'How do I join gCamp?'
    faq2.faq_answer = 'Right now gCamp is still in production. So there is not a sign up page open to the public, yet! Your best options it to become super best friends with
    gCamp developer. They can be found in the hanging around gSchool during the day and hitting the hottest clubs
    at night.'

    faq3 = Faq.new
    faq3.faq_question = 'When will gCamp be finished?'
    faq3.faq_answer = 'gCamp is work in progress. That being said, it should be fully
